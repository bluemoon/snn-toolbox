...
static PyObject* e(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occured = 0;
    PyObject *py_local_dict = NULL;
    static char *kwlist[] = {"time","local_dict", NULL};
    PyObject *py_time;
    int time_used;
    py_time = NULL;
    time_used = 0;
    
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"O|O:e",kwlist,&py_time, &py_local_dict))
       return NULL;
    try                              
    {                                
        py_time = py_time;
        double time = convert_to_float(py_time,"time");
        time_used = 1;
        /*<function call here>*/     
...
{
    {"e",(PyCFunction)e , METH_VARARGS|METH_KEYWORDS},
    {NULL,      NULL}        /* Sentinel */
};

PyMODINIT_FUNC initmath_ext(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("math_ext", compiled_methods);
}

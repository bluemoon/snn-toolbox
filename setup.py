...
modules_ext =  [
        ...
        Extension('modular.spikeprop_network', ['modular/spikeprop_network.pyx'], include_dirs=includes),
        Extension('modular.spikeprop_types', ['modular/spikeprop_types.pyx', aux], include_dirs=includes),
        Extension('old.modular', ['old/modular.pyx', aux], include_dirs=includes),
        Extension('old.Math', ['old/Math.pyx', aux], include_dirs=includes),
        Extension('old.ng', ['old/ng.pyx', aux], include_dirs=includes),
        ]
...
setup(
    ...
    packages=['snn_toolbox', 'snn_toolbox.modular', 'snn_toolbox.old'],
    package_dir={'snn_toolbox': 'python', 'snn_toolbox.modular':'modular', 'snn_toolbox.old':'old'}, #'snn_toolbox.old':'old'},
    version='0.0.1.8f',
